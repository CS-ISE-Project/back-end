...
from app.routers import user_router, admin_router, moderator_router, article_router, favorite_router, auth_router, search_router, upload_router, moderation_router
