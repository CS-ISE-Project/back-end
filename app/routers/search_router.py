...
@router.post("/simple", response_model=List[CompleteArticleModel])
...
@router.post("/simple/filter", response_model=List[CompleteArticleModel])
...
@router.post("/advanced", response_model=List[CompleteArticleModel])
...
@router.post("/advanced/filter", response_model=List[CompleteArticleModel])
